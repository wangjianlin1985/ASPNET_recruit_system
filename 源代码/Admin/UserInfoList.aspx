   ...
   <form id="form1" runat="server">
    ...
    <div class="Body_Title">用户管理 》》用户列表</div>
     <div class="Body_Search">
        ...
        学历&nbsp;&nbsp;<asp:TextBox ID="xl" runat="server" Width="123px"></asp:TextBox> &nbsp;&nbsp;
    ...
    <asp:Repeater ID="RpUserInfo" runat="server" onitemcommand="RpUserInfo_ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><%#Eval("xl")%> </td>
                <td align="center"><%#Eval("telephone")%> </td>
                <td align="center"><%#Eval("email")%> </td>
                <td><%#Eval("jianliFile").ToString() == ""?"暂无文件":"<a href='../" + Eval("jianliFile").ToString() + "' target='_blank'>" + Eval("jianliFile").ToString() +  "</a>" %></td>
                <td><%#Eval("smrzzl").ToString() == ""?"暂无文件":"<a href='../" + Eval("smrzzl").ToString() + "' target='_blank'>" + Eval("smrzzl").ToString() +  "</a>" %></td>
