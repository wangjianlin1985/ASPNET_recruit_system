        ...
        protected void BtnLogin_Click(object sender, EventArgs e)
        {
            if (CheckNull())
            {
                ...
                else
                {
                    ...
                    if (Session["IsCusAdmin"].ToString() == "0")
                    {
                    ...
                    else 
                    {
                        ...
                        bool success = BLL.bllCompany.ulogin(uID, txtU_Pass.Value.ToString());
                        ...
                        {
                            Common.ShowMessage.Show(Page, "Error1", "帐号密码不正确或未审核." + pwdMd5, "M_UserLogin.aspx");
                        }
