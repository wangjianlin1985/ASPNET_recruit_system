    ...
    public partial class UserInfoList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request["xl"] != null && Request["xl"].ToString() != "")
                {
                    sqlstr += "  and xl like '%" + Request["xl"].ToString() + "%'";
                    xl.Text = Request["xl"].ToString();
                }
        ...
        {
            Response.Redirect("UserInfoList.aspx?user_name=" + user_name.Text.Trim() + "&&name=" + name.Text.Trim()+ "&&birthDate=" + birthDate.Text.Trim()+ "&&xl=" + xl.Text.Trim()+ "&&telephone=" + telephone.Text.Trim()+ "&&shzt=" + shzt.Text.Trim());
        }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            sb.Append("<thead><tr><th colSpan='12'>用户记录</th></tr>");
            ...
            sb.Append("<th>邮箱</th>");
            sb.Append("<th>简历文件</th>");
            sb.Append("<th>实名认证资料</th>");
            ...
            for (int i = 0; i < userInfoDataSet.Tables[0].Rows.Count; i++)
            {
                ...
                sb.Append("<td>" + dr["xl"].ToString() + "</td>");
                sb.Append("<td>" + dr["telephone"].ToString() + "</td>");
                sb.Append("<td>" + dr["email"].ToString() + "</td>");
                sb.Append("<td>" + dr["jianliFile"].ToString() + "</td>");
                sb.Append("<td>" + dr["smrzzl"].ToString() + "</td>");
