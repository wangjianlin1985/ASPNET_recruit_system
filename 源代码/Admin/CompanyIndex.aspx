<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CompanyIndex.aspx.cs" Inherits="WebSystem.Admin.CompanyIndex" %>
...
<frameset rows="50,*,20"  frameborder="no" frameborder="1" framespacing="0">
  ...
  <frameset cols="184,*"   id="frame">
	<frame src="Company_Left.aspx" name="leftFrame" noresize="noresize" marginwidth="0" marginheight="0" frameborder="1" scrolling="no" target="lefts" />
