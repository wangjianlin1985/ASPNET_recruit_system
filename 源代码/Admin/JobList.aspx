<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JobList.aspx.cs" Inherits="chengxusheji.Admin.JobList" %>
   ...
   <form id="form1" runat="server">
    ...
    <div class="Body_Title">职位管理 》》职位列表</div>
     <div class="Body_Search">
        ...
        发布企业&nbsp;&nbsp;<asp:DropDownList ID="companyObj" runat="server"></asp:DropDownList>  &nbsp;&nbsp;
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><%#Eval("viewNum")%> </td>
                  <td align="center"><%#GetCompanycompanyObj(Eval("companyObj").ToString())%></td>
                  <td align="center"><%# Convert.ToDateTime(Eval("addTime")).ToShortDateString() + " " + Convert.ToDateTime(Eval("addTime")).ToLongTimeString() %></td>
                <td align="center"><a href="JobEdit.aspx?jobId=<%#Eval("jobId") %>"><img src="Images/MillMes_ICO.gif" alt="修改信息..." /></a><asp:ImageButton class="DelClass" ID="IBDelClass" runat="server" CommandArgument='<%#Eval("jobId")%>' CommandName="Del" ImageUrl="Images/Delete.gif"  ToolTip="删除该信息..."/></td>
             </tr>
        </ItemTemplate>
