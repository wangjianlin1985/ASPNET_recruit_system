        ...
        <table cellspacing="1" cellpadding="2">
                <tr>
                 ...
                 <tr>
                   ...
                   学历：</td>
                    <td width="650px;">
                         <input id="xl" type="text"   style="width:200px;" runat="server" maxlength="25"/><span class="WarnMes">*</span>请输入学历！</td>
                </tr>
                ...
                <tr>
                   ...
                   简历文件：</td>
                    <td width="650px;">
                     <table cellpadding="0px" cellspacing="0px" width="90%">
                        <tr><td width="400px">
                         文件下载：<asp:HyperLink  ID="jianliFile" runat="server"></asp:HyperLink > &nbsp; &nbsp; &nbsp;
                         <br /><br />
                         上传文件：<asp:FileUpload ID="JianliFileUpload" runat="server" Width="237px" />&nbsp;
                         <asp:Button ID="Btn_JianliFileUpload" runat="server" Text="上传" OnClick="Btn_JianliFileUpload_Click" /></td><td>
                         </td></tr>
                       </table>
                    </td>
                </tr>
                <tr>
                   ...
                   实名认证资料：</td>
                    <td width="650px;">
                     <table cellpadding="0px" cellspacing="0px" width="90%">
                        <tr><td width="400px">
                         文件下载：<asp:HyperLink  ID="smrzzl" runat="server"></asp:HyperLink > &nbsp; &nbsp; &nbsp;
                         <br /><br />
                         上传文件：<asp:FileUpload ID="SmrzzlUpload" runat="server" Width="237px" />&nbsp;
                         <asp:Button ID="Btn_SmrzzlUpload" runat="server" Text="上传" OnClick="Btn_SmrzzlUpload_Click" /></td><td>
                         </td></tr>
                       </table>
                    </td>
                </tr>
