...
<body>
   <form id="form1" runat="server">
    <div class="div_All">
    <div class="Body_Title">简历投递管理 》》简历投递列表</div>
     <div class="Body_Search">
        <asp:DropDownList ID="jobObj" runat="server" Visible="false"></asp:DropDownList>  &nbsp;&nbsp;
        应聘人&nbsp;&nbsp;<asp:DropDownList ID="userObj" runat="server"></asp:DropDownList>  &nbsp;&nbsp;
        投递时间&nbsp;&nbsp; <asp:TextBox ID="deliveryTime"  runat="server" Width="112px" onclick="SelectDate(this,'yyyy-MM-dd');"></asp:TextBox>&nbsp;&nbsp;
        处理时间&nbsp;&nbsp; <asp:TextBox ID="handleTime"  runat="server" Width="112px" onclick="SelectDate(this,'yyyy-MM-dd');"></asp:TextBox>&nbsp;&nbsp;
        处理状态&nbsp;&nbsp;<asp:TextBox ID="clzt" runat="server" Width="123px"></asp:TextBox> &nbsp;&nbsp;
    ...
    <asp:Repeater ID="RpDelivery" runat="server" onitemcommand="RpDelivery_ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><a href="companyDeliveryEdit.aspx?deliveryId=<%#Eval("deliveryId") %>"><img src="Images/MillMes_ICO.gif" alt="修改信息..." /></a><asp:ImageButton class="DelClass" ID="IBDelClass" runat="server" CommandArgument='<%#Eval("deliveryId")%>' CommandName="Del" ImageUrl="Images/Delete.gif"  ToolTip="删除该信息..."/></td>
             </tr>
        </ItemTemplate>
