<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userFrontList.aspx.cs" Inherits="Leaveword_frontList" %>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>留言标题</td><td>留言时间</td><td>管理回复</td><td>回复时间</td><td>操作</td></tr>
				    					<asp:Repeater ID="RpLeaveword" runat="server">
 										...
 										<tr>
 											...
 											<td>
 												...
 												<a href="#" onclick="leavewordDelete('<%#Eval("leaveWordId")%>');"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
 										</ItemTemplate>
 										</asp:Repeater>
