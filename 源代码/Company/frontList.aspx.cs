...
using System.Data;
public partial class Company_frontList : System.Web.UI.Page
{
    ...
    protected void LBEnd_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("frontList.aspx?qyjb=" + qyjb.Text.Trim() + "&&companyName=" + companyName.Text.Trim()+ "&&gszch=" + gszch.Text.Trim()+ "&&gsxz=" + gsxz.Text.Trim()+ "&&gsgm=" + gsgm.Text.Trim()+ "&&gghy=" + gghy.Text.Trim()+ "&&lxr=" + lxr.Text.Trim()+ "&&lxdh=" + lxdh.Text.Trim()+ "&&shzt=" + shzt.Text.Trim());
        }
