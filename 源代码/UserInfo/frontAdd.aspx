		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group">
				  	 ...
				  	 <div class="col-md-8">
					    <input type="text" id="userInfo_xl" name="userInfo.xl" class="form-control" placeholder="请输入学历">
					 </div>
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
				  	 ...
				  	 <div class="col-md-8">
					    <a id="userInfo_jianliFileImg" border="0px"></a><br/>
				  ...
				  <div class="form-group">
				  	 ...
				  	 <div class="col-md-8">
					    <a id="userInfo_smrzzlImg" border="0px"></a><br/>
