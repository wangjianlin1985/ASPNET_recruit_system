...
public partial class UserInfo_frontList : System.Web.UI.Page
{
    ...
    protected void LBEnd_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("frontList.aspx?user_name=" + user_name.Text.Trim() + "&&name=" + name.Text.Trim()+ "&&birthDate=" + birthDate.Text.Trim()+ "&&xl=" + xl.Text.Trim()+ "&&telephone=" + telephone.Text.Trim()+ "&&shzt=" + shzt.Text.Trim());
        }
