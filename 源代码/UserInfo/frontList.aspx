			...
			<div class="col-md-3 bottom15" <%#(((Container.ItemIndex+0)%4==0)?"style='clear:left;'":"") %>>
			  <a href="frontshow.aspx?user_name=<%#Eval("user_name")%>"><img class="img-responsive" src="../<%#Eval("userPhoto")%>" /></a>
			     <div class="showFields">
			     	...
			     	<div class="field">
	            		简历文件:<%#Eval("jianliFile").ToString() == ""?"暂无文件":"<a href='../" + Eval("jianliFile").ToString() + "' target='_blank'>" + Eval("jianliFile").ToString() +  "</a>" %>
			     	</div>
			     	<div class="field">
	            		实名认证资料:<%#Eval("smrzzl").ToString() == ""?"暂无文件":"<a href='../" + Eval("smrzzl").ToString() + "' target='_blank'>" + Eval("smrzzl").ToString() +  "</a>" %>
			     	</div>
			     	<div class="field">
	            		审核状态: <%#Eval("shzt")%>
			     	</div>
	...
	<div class="col-md-3 wow fadeInRight">
		<div class="page-header">
			...
			<div class="form-group">
				...
				<asp:TextBox ID="xl" runat="server"  CssClass="form-control" placeholder="请输入学历"></asp:TextBox>
			</div>
			<div class="form-group">
