<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frontAdd.aspx.cs" Inherits="WebLink_frontAdd" %>
...
<uc:header ID="header" runat="server" />
	<div class="col-md-12 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>WebLink/frontList.aspx">友情链接管理</a></li>
...
var basePath = "<%=basePath%>";
	...
	function ajaxWebLinkAdd() { 
		...
		jQuery.ajax({
			type : "post",
			url : basePath + "WebLink/WebLinkController.aspx?action=add",
			dataType : "json" , 
