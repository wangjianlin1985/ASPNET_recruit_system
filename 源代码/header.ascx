...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.aspx" class="navbar-brand">就业招聘网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>JobType/frontlist.aspx">职位类别</a></li>
                <li><a href="<%=basePath %>Delivery/frontlist.aspx">简历投递</a></li>-->
                <li><a href="<%=basePath %>Company/frontlist.aspx">企业信息</a></li> 
                <li><a href="<%=basePath %>Job/frontlist.aspx">职位搜索</a></li>
                <li><a href="<%=basePath %>JobRecord/frontlist.aspx">兼职记录</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="<%=basePath %>Company/frontAdd.aspx"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;企业注册</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Delivery/userFrontlist.aspx"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我投递的职位</a></li>
                        <li><a href="<%=basePath %>JobRecord/userFrontAdd.aspx"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布兼职记录</a></li>
                        <li><a href="<%=basePath %>JobRecord/userFrontlist.aspx"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的兼职记录</a></li>
                        <li><a href="<%=basePath %>Leaveword/userFrontAdd.aspx"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布留言</a></li>
                        <li><a href="<%=basePath %>Leaveword/userFrontlist.aspx"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我的网站留言</a></li>
